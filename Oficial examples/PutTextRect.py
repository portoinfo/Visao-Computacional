...
while True:
    ...
    img, bbox = cvzone.putTextRect(
        img, "Adelcio Porto", (150, 50),  # Image and starting position of the rectangle
        scale=3, thickness=3,  # Font scale and thickness
        colorT=(255, 255, 255), colorR=(125, 125, 125),  # Text color and Rectangle color
        font=cv2.FONT_HERSHEY_PLAIN,  # Font type
        offset=10,  # Offset of text inside the rectangle
        border=5, colorB=(255, 0, 0)  # Border thickness and color
    )
